  ...
  const showcaseSlides = [
    {
      ...
      description: "Discover cutting-edge virtual reality technology and immerse yourself in the future of innovation.",
    ...
    },
    {
      ...
      button: "Join LEAP Program",
      description: "Transform your innovative ideas into successful businesses with our comprehensive incubation program.",
      src: "/startup-incubation-workspace.jpg",
    },
    {
      title: "Tech Workshops",
      button: "View Schedule",
      description: "Learn from industry experts through hands-on workshops covering the latest technologies and trends.",
      src: "/technology-workshop-students-coding.jpg",
    },
    {
      title: "Innovation Events",
      button: "See Events",
      description: "Join our community events, hackathons, and networking sessions to connect with fellow innovators.",
